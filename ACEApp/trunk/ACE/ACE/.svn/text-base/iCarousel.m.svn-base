...
- (void)scrollByNumberOfItems:(NSInteger)itemCount duration:(NSTimeInterval)duration
{
    if (duration > 0.0)
    {
       ...
       // iCarousel *cal=[[iCarousel alloc]init];
        //[cal loadViewAtIndex:previousItemIndex];
...
//New method added.
- (void)scrollWithoutContentChangeToItemAtIndex:(int)index
{
    scrolling = NO;
    decelerating = NO;
    [self disableAnimation];
    
    scrollOffset = itemWidth * [self clampedIndex:0 + index];
    previousItemIndex = previousItemIndex + index;
